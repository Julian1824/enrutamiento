<center>
      <form class="form-inline my-2 my-lg-0">
                ...
                <tbody>
                    ...
                    ?>
                    <td style="width:10%;">
                        <a href="View/transacciones/editarEpm.php?id_matriz=<?= $datos->id_matriz ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-user-pen" style="color:#FFFFFF; "></i></a>
                        <a href="View/transacciones/eliminarEpm.php?id_matriz=<?= $datos->id_matriz ?>" class="btn btn-small  btn-danger"><i class="fa-solid fa-user-slash"></i></a>
                    </td>    
                    </tr>
                    <?php
                    } 
