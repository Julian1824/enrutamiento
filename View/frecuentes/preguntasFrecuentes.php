      ...
      <tbody>
        <?php 
            ...
            <?php
                        ...
                        ?>
                    <td style="width:10%;">
                        <a href="View/frecuentes/editarFrecuentes.php?id_matriz=<?= $datos->id_matriz ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-user-pen" style="color:#FFFFFF; "></i></a>
                        <a href="View/frecuentes/eliminarFrecuentes.php?id_matriz=<?= $datos->id_matriz ?>" class="btn btn-small  btn-danger"><i class="fa-solid fa-user-slash"></i></a>
                    </td>   
    </tr>
    <?php
    } 
