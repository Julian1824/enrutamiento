<?php
    ...
    $sql = $conexion->query("SELECT * FROM matriz_respuestas WHERE id_matriz=$id_matriz");
        ...
        <div class="d-flex justify-content-center">
                ...
                <form method="POST" class="bg-light rounded">
                    ...
                    <h3 class="titulos text-center bg-success" >Editar</h3>
                        ...
                        <?php
                            include ("../../Controller/filtroController/editarController.php");
                            while($datos=$sql->fetch_object()){
                        ?>

                    <div class="p-1">
                         <label for="Pregunta frecuente	" class="">Inquietud</label>
                         <textarea name="Inquietud"  cols="30" rows="3" class="form-control" value=""><?php echo $datos->Inquietud; ?></textarea>                     
                    </div>
                    <div class="p-1">
                         <label for="Pregunta frecuente	" class="">Pregunta filtro</label>
                         <textarea name="pregunta_filtro"  cols="30" rows="3" class="form-control" value=""><?php echo $datos->pregunta_filtro; ?></textarea>                     
                    </div>
                    <div class="p-1">
                         <label for="Pregunta frecuente	" class="">Respuesta a la pregunta filtro</label>
                         <textarea name="respue_filtro"  cols="30" rows="3" class="form-control" value=""><?php echo $datos->respue_filtro; ?></textarea>                     
                    </div>
                    ...
                    <div class="row p-1">
                    <div class="col s6">
                        <button type="submit" class="btn buttonConfirmar w-100" name="btnEditarRespuestas" value="oklisto">Guardar</button>
                    </div>
                    <div class="col s6"> 
