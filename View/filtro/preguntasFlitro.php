                            ...
                            <table id='example-table2' class="table table-bordered table-striped border border-4"
                                ...
                                <thead class="text-white">
                                    <tr height=40 style='height:30.0pt'>
                                        ...
                                        <td class=xl69 width=131
                                            style='border-left:none;width:98pt;background-color:#198754;'>Acciones
                                            <span style='mso-spacerun:yes'> </span>
                                        </td>
                                    </tr>
                                </thead>
  ...
  <tbody>
                    ...
                    ?>
                    <td style="width:10%;">
                        <a href="View/filtro/editarFiltro.php?id_matriz=<?= $datos->id_matriz ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-user-pen" style="color:#FFFFFF; "></i></a>
                        <a href="View/filtro/eliminarFiltro.php?id_matriz=<?= $datos->id_matriz ?>" class="btn btn-small  btn-danger"><i class="fa-solid fa-user-slash"></i></a>
                    </td>     
                </tr>
                    <?php
                    } 
