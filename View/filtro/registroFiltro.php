...
<html lang="en">
  ...
  <body>
    ...
    <?php
        ...
        include ("../../Controller/filtroController/registroController.php");
    ?>
        ...
        <div class="d-flex justify-content-center">
                ...
                <form method="POST" class="bg-light rounded">
                    ...
                    <div class="p-3">
                         ...
                         <input name="Inquietud"  cols="30" rows="3" class="form-control" value="">                     
                    </div>
                    <div class="p-3">
                         <label for="Pregunta frecuente	" class="">Pregunta filtro</label>
                         <input name="pregunta_filtro"  cols="30" rows="3" class="form-control" value="">                   
                    </div>
                    <div class="p-1">
                         <label for="Pregunta frecuente	" class="">Respuesta a la pregunta filtro</label>
                         <textarea name="respue_filtro"  cols="30" rows="3" class="form-control" value=""></textarea>                     
                    </div>
                    ...
                    <div class="row p-1">
                    <div class="col s6">
                        <button type="submit" class="btn buttonConfirmar w-100" name="btnRegistroRespuestas" value="oklisto">Guardar</button>
                    </div>
                    <div class="col s6"> 
