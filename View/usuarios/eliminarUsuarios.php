    ...
    <div class="container-fluid row">
        <div class="d-flex justify-content-center">
                ...
                <?php
                      ...
                      include ("../../Controller/usuariosController/eliminarController.php");
                 ?>
                <form method="POST" class="bg-light rounded">
                    ...
                    <div class="p-1">
                    <div class="col s6">
                        <button type="submit" class="btn buttonConfirmar w-100" name="btnFrecuenciaEliminar" value="oklisto">Guardar</button>
                    </div>
                    <div class="col s6"> 
